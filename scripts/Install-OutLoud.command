...
# Points at main, deliberately. An earlier copy of this file fetched from a
# feature branch, which meant the double-click installer would break the day
# that branch was deleted -- and the script it fetched did not exist on main
# at all. A public install path must not depend on a branch surviving.
URL="https://raw.githubusercontent.com/blarer/outloud/main/scripts/install.sh"
